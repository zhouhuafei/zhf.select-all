...
"use strict";var extend=require("zhf.extend"),getDomArray=require("zhf.get-dom-array"),eventDelegate=require("zhf.event-delegate");function SelectAll(e){this.opts=extend({items:null,isOpenEventDelegate:!1,isFilterDisabled:!0,callback:{click:function(){}}},e),this.init()}SelectAll.prototype.init=function(){this.itemsDom=getDomArray(this.opts.items),this.power()},SelectAll.prototype.selectNothing=function(){var e=this,t=e.opts;t.isOpenEventDelegate&&(e.itemsDom=getDomArray(t.items)),e.itemsDom.forEach(function(e){t.isFilterDisabled&&e.disabled||(e.checked=!1)})},SelectAll.prototype.selectAll=function(){var e=this,t=e.opts;t.isOpenEventDelegate&&(e.itemsDom=getDomArray(t.items)),e.itemsDom.forEach(function(e){t.isFilterDisabled&&e.disabled||(e.checked=!0)})},SelectAll.prototype.selectReverse=function(){var e=this,t=e.opts;t.isOpenEventDelegate&&(e.itemsDom=getDomArray(t.items)),e.itemsDom.forEach(function(e){t.isFilterDisabled&&e.disabled||(e.checked=!e.checked)})},SelectAll.prototype.isSelectAll=function(){var e=this,t=e.opts;t.isOpenEventDelegate&&(e.itemsDom=getDomArray(t.items));var i=!0;return e.itemsDom.forEach(function(e){t.isFilterDisabled&&e.disabled||!1===e.checked&&(i=!1)}),i},SelectAll.prototype.power=function(){var e=this,t=e.opts;t.isOpenEventDelegate?eventDelegate.on(document,"click",t.items,function(){t.callback.click({element:this,isCheckedAll:e.isSelectAll()})}):e.itemsDom.forEach(function(i){i.isBindSelectAllClick||i.addEventListener("click",function(){i.isBindSelectAllClick=!0,t.callback.click({element:this,isCheckedAll:e.isSelectAll()})})})},module.exports=SelectAll;
},{"zhf.event-delegate":3,"zhf.extend":5,"zhf.get-dom-array":6}],3:[function(require,module,exports){
...
},{"zhf.get-dom-array":4,"zhf.type-of":7}],4:[function(require,module,exports){
